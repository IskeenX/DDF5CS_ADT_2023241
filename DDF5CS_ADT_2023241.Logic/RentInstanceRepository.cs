...
namespace DDF5CS_ADT_2023241.Logic
{
    public class RentInstanceRepository : IRentInstanceRepository
    {
        ...
        public RentInstanceRepository(AppDbContext dbContext) { _dbContext = dbContext; }
        public IEnumerable<RentInstance> GetAllRentInstances() { return _dbContext.RentInstances.ToList(); }
        public RentInstance? Read(int id) { return _dbContext.RentInstances.Find(id); }
        public IQueryable<RentInstance> ReadAll() { return _dbContext.RentInstances.AsQueryable(); }
